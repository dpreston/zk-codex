...
var _dpreston$zk_codex$ZK_Data$JsonRoot = function (a) {
	return {records: a};
};
...
var _dpreston$zk_codex$ZK_Data$World = {ctor: 'World'};
var _dpreston$zk_codex$ZK_Data$Power = {ctor: 'Power'};
var _dpreston$zk_codex$ZK_Data$Character = {ctor: 'Character'};
var _dpreston$zk_codex$ZK_Data$defaultRecord = A5(
	_dpreston$zk_codex$ZK_Data$Record,
	0,
	'<No Record>',
	_dpreston$zk_codex$ZK_Data$Character,
	0,
	{ctor: '[]'});
var _dpreston$zk_codex$ZK_Data$categoryDecoder = function (string) {
	var category = function () {
		...
		switch (_p0) {
			case 'character':
				return _dpreston$zk_codex$ZK_Data$Character;
			case 'power':
				return _dpreston$zk_codex$ZK_Data$Power;
			case 'world':
				return _dpreston$zk_codex$ZK_Data$World;
			default:
...
var _dpreston$zk_codex$Main$Model = F5(
	function (a, b, c, d, e) {
		return {allRecords: a, displayRecords: b, currentRecord: c, filters: d, headerHue: e};
	});
var _dpreston$zk_codex$Main$init = A5(
	_dpreston$zk_codex$Main$Model,
	{ctor: '[]'},
	{ctor: '[]'},
	_elm_lang$core$Maybe$Nothing,
	{page: 100, category: _dpreston$zk_codex$ZK_Data$Character, text: _elm_lang$core$Maybe$Nothing},
	0);
var _dpreston$zk_codex$Main$Filters = F3(
	function (a, b, c) {
		return {page: a, category: b, text: c};
	});
...
var _dpreston$zk_codex$Main$filterView = function (filters) {
	var buttonClass = F2(
		function (a, b) {
			var _p3 = _elm_lang$core$Native_Utils.eq(a, b);
			if (_p3 === true) {
								...
								_1: {
									...
									_1: {
										...
										_0: _elm_lang$html$Html_Attributes$max(
											_elm_lang$core$Basics$toString(2000)),
										_1: {ctor: '[]'}
									}
								}
							}
				...
				_0: A2(
					...
					},
					{
						...
						_0: A2(
							...
							{
								ctor: '::',
								_0: A2(buttonClass, _dpreston$zk_codex$ZK_Data$Character, filters.category),
								_1: {
									ctor: '::',
									_0: _elm_lang$html$Html_Events$onClick(
										_dpreston$zk_codex$Main$SelectCategory(_dpreston$zk_codex$ZK_Data$Character)),
									_1: {ctor: '[]'}
								}
							},
							{
						...
						_1: {
							...
							_0: A2(
								...
								{
									ctor: '::',
									_0: A2(buttonClass, _dpreston$zk_codex$ZK_Data$Power, filters.category),
									_1: {
										ctor: '::',
										_0: _elm_lang$html$Html_Events$onClick(
											_dpreston$zk_codex$Main$SelectCategory(_dpreston$zk_codex$ZK_Data$Power)),
										_1: {ctor: '[]'}
									}
								},
								{
							...
							_1: {
								...
								_0: A2(
									...
									{
										ctor: '::',
										_0: A2(buttonClass, _dpreston$zk_codex$ZK_Data$World, filters.category),
										_1: {
											ctor: '::',
											_0: _elm_lang$html$Html_Events$onClick(
												_dpreston$zk_codex$Main$SelectCategory(_dpreston$zk_codex$ZK_Data$World)),
											_1: {ctor: '[]'}
										}
									},
									{
...
var _dpreston$zk_codex$Main$update = F2(
	function (msg, _p4) {
		var _p5 = _p4;
		var _p12 = _p5;
		var _p11 = _p5.filters;
		var _p6 = msg;
		switch (_p6.ctor) {
			case 'FetchData':
				return {ctor: '_Tuple2', _0: _p12, _1: _dpreston$zk_codex$Main$fetchDataCmd};
			case 'FetchDataCompleted':
				var _p7 = _p6._0;
				if (_p7.ctor === 'Ok') {
					var _p8 = _p7._0.records;
					return {
						ctor: '_Tuple2',
						_0: _elm_lang$core$Native_Utils.update(
							...
							{
								allRecords: _p8,
								displayRecords: A2(_dpreston$zk_codex$Main$filterRecords, _p11, _p8)
							}),
			...
			case 'UpdatePage':
				...
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						...
						{
							filters: filters_,
							displayRecords: A2(_dpreston$zk_codex$Main$filterRecords, filters_, _p12.allRecords)
						}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			case 'UpdateSearch':
				...
				var search_ = function () {
					var _p9 = _elm_lang$core$String$isEmpty(_p10);
					if (_p9 === false) {
			...
			case 'ShowRecord':
				var record = _elm_lang$core$List$head(
					A2(
						_elm_lang$core$List$filter,
						function (r) {
							return _elm_lang$core$Native_Utils.eq(r.id, _p6._0);
						},
						_p12.allRecords));
				return {
					ctor: '_Tuple2',
			...
			default:
				var next = _elm_lang$core$Basics$floor(_p12.headerHue + 90);
