...
var _dpreston$zk_codex$ZK_Data$JsonData = function (a) {
	return {records: a};
};
var _dpreston$zk_codex$ZK_Data$Record = F4(
	function (a, b, c, d) {
		return {id: a, name: b, firstPage: c, entries: d};
	});
var _dpreston$zk_codex$ZK_Data$defaultRecord = A4(
...
var _dpreston$zk_codex$ZK_Data$Entry = F4(
	function (a, b, c, d) {
		return {id: a, page: b, summary: c, text: d};
	});
var _dpreston$zk_codex$ZK_Data$defaultEntry = A4(
	...
	'<No Content>');
var _dpreston$zk_codex$ZK_Data$entryDecoder = A3(
...
var _dpreston$zk_codex$ZK_Data$dataDecoder = A3(
	...
	_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$decode(_dpreston$zk_codex$ZK_Data$JsonData));
...
var _dpreston$zk_codex$Main$rightView = function (model) {
	var record = A2(
		...
		_dpreston$zk_codex$ZK_Data$defaultRecord,
		_elm_lang$core$List$head(
			A2(
				_elm_lang$core$List$filter,
				function (r) {
					return _elm_lang$core$Native_Utils.eq(r.id, model.currentRecord);
				},
		...
		_elm_lang$core$List$head(
			_elm_lang$core$List$reverse(
				A2(
					...
					record.entries))));
	var summary = A2(_elm_lang$core$Maybe$withDefault, 'huh', entry.summary);
	return A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
		...
		},
		{
			...
			_0: _dpreston$zk_codex$Main$rightHeader(
				{ctor: '_Tuple2', _0: record, _1: model.headerHue}),
			_1: {
				ctor: '::',
				_0: A2(
					_elm_lang$html$Html$div,
...
var _dpreston$zk_codex$Main$Model = F5(
	function (a, b, c, d, e) {
		return {allRecords: a, displayRecords: b, filters: c, currentRecord: d, headerHue: e};
	});
var _dpreston$zk_codex$Main$init = A5(
	_dpreston$zk_codex$Main$Model,
	{ctor: '[]'},
	{ctor: '[]'},
	{page: 100, text: _elm_lang$core$Maybe$Nothing},
	0,
	0);
var _dpreston$zk_codex$Main$Filters = F2(
	function (a, b) {
		return {page: a, text: b};
	});
				...
				_0: A2(
					...
					},
					{
						...
						_0: A2(
							...
							{
								ctor: '::',
								_0: _elm_lang$html$Html$text('characters'),
								_1: {ctor: '[]'}
							}),
						_1: {
							ctor: '::',
...
var _dpreston$zk_codex$Main$update = F2(
	function (msg, _p3) {
		...
		switch (_p5.ctor) {
			case 'FetchData':
				return {ctor: '_Tuple2', _0: _p9, _1: _dpreston$zk_codex$Main$fetchDataCmd};
			case 'FetchDataCompleted':
				var _p6 = _p5._0;
				if (_p6.ctor === 'Ok') {
					var _p7 = _p6._0.records;
					return {
						ctor: '_Tuple2',
						_0: _elm_lang$core$Native_Utils.update(
							...
							{
								allRecords: _p7,
								displayRecords: A2(_dpreston$zk_codex$Main$filterRecords, _p8, _p7)
							}),
			...
			case 'UpdatePage':
				...
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						...
						{
							filters: filters_,
							displayRecords: A2(_dpreston$zk_codex$Main$filterRecords, filters_, _p9.allRecords)
						}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			case 'UpdateSearch':
				var filters_ = _elm_lang$core$Native_Utils.update(
					_p8,
					{
						text: _elm_lang$core$Maybe$Just(_p5._0)
					});
				var displayRecords_ = A2(_dpreston$zk_codex$Main$filterRecords, filters_, _p9.allRecords);
				return {
					ctor: '_Tuple2',
					_0: _elm_lang$core$Native_Utils.update(
						_p9,
						{filters: filters_, displayRecords: displayRecords_}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			case 'ShowRecord':
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						_p9,
						{currentRecord: _p5._0}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			default:
				var next = _elm_lang$core$Basics$floor(_p9.headerHue + 90);
...
if (typeof _dpreston$zk_codex$Main$main !== 'undefined') {
    _dpreston$zk_codex$Main$main(Elm['Main'], 'Main', {"types":{"unions":{"Dict.LeafColor":{"args":[],"tags":{"LBBlack":[],"LBlack":[]}},"Dict.Dict":{"args":["k","v"],"tags":{"RBNode_elm_builtin":["Dict.NColor","k","v","Dict.Dict k v","Dict.Dict k v"],"RBEmpty_elm_builtin":["Dict.LeafColor"]}},"Maybe.Maybe":{"args":["a"],"tags":{"Just":["a"],"Nothing":[]}},"Main.Msg":{"args":[],"tags":{"FetchData":[],"Tick":["Time.Time"],"UpdateSearch":["String"],"UpdatePage":["String"],"ShowRecord":["Int"],"FetchDataCompleted":["Result.Result Http.Error ZK.Data.JsonData"]}},"Dict.NColor":{"args":[],"tags":{"BBlack":[],"Red":[],"NBlack":[],"Black":[]}},"Http.Error":{"args":[],"tags":{"BadUrl":["String"],"NetworkError":[],"Timeout":[],"BadStatus":["Http.Response String"],"BadPayload":["String","Http.Response String"]}},"Result.Result":{"args":["error","value"],"tags":{"Ok":["value"],"Err":["error"]}}},"aliases":{"Http.Response":{"args":["body"],"type":"{ url : String , status : { code : Int, message : String } , headers : Dict.Dict String String , body : body }"},"ZK.Data.Entry":{"args":[],"type":"{ id : Int, page : Int, summary : Maybe.Maybe String, text : String }"},"ZK.Data.JsonData":{"args":[],"type":"{ records : List ZK.Data.Record }"},"ZK.Data.Record":{"args":[],"type":"{ id : Int , name : String , firstPage : Int , entries : List ZK.Data.Entry }"},"Time.Time":{"args":[],"type":"Float"}},"message":"Main.Msg"},"versions":{"elm":"0.18.0"}});
}
