...
var _dpreston$zk_codex$ZK_Data$nameOrdering = _matthewsj$elm_ordering$Ordering$natural;
var _dpreston$zk_codex$ZK_Data$JsonRoot = F2(
	function (a, b) {
		return {records: a, maxPage: b};
	});
var _dpreston$zk_codex$ZK_Data$Record = F5(
	function (a, b, c, d, e) {
		return {id: a, name: b, category: c, firstPage: d, entries: e};
	});
var _dpreston$zk_codex$ZK_Data$Entry = F4(
	function (a, b, c, d) {
		return {id: a, page: b, text: c, summary: d};
	});
var _dpreston$zk_codex$ZK_Data$defaultEntry = A4(
	_dpreston$zk_codex$ZK_Data$Entry,
	0,
	0,
	'<No Content>',
	_elm_lang$core$Maybe$Just('<No Summary>'));
var _dpreston$zk_codex$ZK_Data$entryDecoder = A4(
	...
	A3(
		...
		A3(
			...
			A3(
				...
				'id',
				_elm_lang$core$Json_Decode$int,
				_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$decode(_dpreston$zk_codex$ZK_Data$Entry)))));
var _dpreston$zk_codex$ZK_Data$Invalid = {ctor: 'Invalid'};
var _dpreston$zk_codex$ZK_Data$World = function (a) {
	return {ctor: 'World', _0: a};
};
var _dpreston$zk_codex$ZK_Data$Power = function (a) {
	return {ctor: 'Power', _0: a};
};
var _dpreston$zk_codex$ZK_Data$Character = function (a) {
	return {ctor: 'Character', _0: a};
};
var _dpreston$zk_codex$ZK_Data$Aberration = {ctor: 'Aberration'};
var _dpreston$zk_codex$ZK_Data$Reaper = {ctor: 'Reaper'};
var _dpreston$zk_codex$ZK_Data$Servant = {ctor: 'Servant'};
var _dpreston$zk_codex$ZK_Data$Human = {ctor: 'Human'};
var _dpreston$zk_codex$ZK_Data$defaultRecord = A5(
	_dpreston$zk_codex$ZK_Data$Record,
	0,
	'<No Record>',
	_dpreston$zk_codex$ZK_Data$Character(_dpreston$zk_codex$ZK_Data$Human),
	0,
	{ctor: '[]'});
var _dpreston$zk_codex$ZK_Data$Unknown = {ctor: 'Unknown'};
var _dpreston$zk_codex$ZK_Data$Shadow = {ctor: 'Shadow'};
var _dpreston$zk_codex$ZK_Data$Hyper = {ctor: 'Hyper'};
var _dpreston$zk_codex$ZK_Data$Elemental = {ctor: 'Elemental'};
var _dpreston$zk_codex$ZK_Data$Other = {ctor: 'Other'};
var _dpreston$zk_codex$ZK_Data$House = {ctor: 'House'};
var _dpreston$zk_codex$ZK_Data$Faction = {ctor: 'Faction'};
var _dpreston$zk_codex$ZK_Data$Location = {ctor: 'Location'};
var _dpreston$zk_codex$ZK_Data$categoryOrdering = _matthewsj$elm_ordering$Ordering$explicit(
	{
		ctor: '::',
		_0: _dpreston$zk_codex$ZK_Data$Character(_dpreston$zk_codex$ZK_Data$Servant),
		_1: {
			ctor: '::',
			_0: _dpreston$zk_codex$ZK_Data$Character(_dpreston$zk_codex$ZK_Data$Reaper),
			_1: {
				ctor: '::',
				_0: _dpreston$zk_codex$ZK_Data$Character(_dpreston$zk_codex$ZK_Data$Aberration),
				_1: {
					ctor: '::',
					_0: _dpreston$zk_codex$ZK_Data$Character(_dpreston$zk_codex$ZK_Data$Human),
					_1: {
						ctor: '::',
						_0: _dpreston$zk_codex$ZK_Data$Power(_dpreston$zk_codex$ZK_Data$Elemental),
						_1: {
							ctor: '::',
							_0: _dpreston$zk_codex$ZK_Data$Power(_dpreston$zk_codex$ZK_Data$Hyper),
							_1: {
								ctor: '::',
								_0: _dpreston$zk_codex$ZK_Data$Power(_dpreston$zk_codex$ZK_Data$Shadow),
								_1: {
									ctor: '::',
									_0: _dpreston$zk_codex$ZK_Data$Power(_dpreston$zk_codex$ZK_Data$Unknown),
									_1: {
										ctor: '::',
										_0: _dpreston$zk_codex$ZK_Data$World(_dpreston$zk_codex$ZK_Data$Faction),
										_1: {
											ctor: '::',
											_0: _dpreston$zk_codex$ZK_Data$World(_dpreston$zk_codex$ZK_Data$House),
											_1: {
												ctor: '::',
												_0: _dpreston$zk_codex$ZK_Data$World(_dpreston$zk_codex$ZK_Data$Location),
												_1: {
													ctor: '::',
													_0: _dpreston$zk_codex$ZK_Data$World(_dpreston$zk_codex$ZK_Data$Other),
													_1: {ctor: '[]'}
												}
											}
										}
...
var _dpreston$zk_codex$ZK_Data$recordOrdering = A2(
	_matthewsj$elm_ordering$Ordering$breakTiesWith,
	A2(
		_matthewsj$elm_ordering$Ordering$byFieldWith,
		_dpreston$zk_codex$ZK_Data$nameOrdering,
		function (_) {
			return _.name;
		}),
	A2(
		_matthewsj$elm_ordering$Ordering$byFieldWith,
		_dpreston$zk_codex$ZK_Data$categoryOrdering,
		function (_) {
			return _.category;
		}));
var _dpreston$zk_codex$ZK_Data$categoryDecoder = function (string) {
	var parts = A2(
	...
	var category = function () {
			...
			if (((_p0.ctor === '::') && (_p0._1.ctor === '::')) && (_p0._1._1.ctor === '[]')) {
				switch (_p0._0) {
					case 'character':
						switch (_p0._1._0) {
							case 'human':
								return _dpreston$zk_codex$ZK_Data$Character(_dpreston$zk_codex$ZK_Data$Human);
							case 'servant':
								return _dpreston$zk_codex$ZK_Data$Character(_dpreston$zk_codex$ZK_Data$Servant);
							case 'reaper':
								return _dpreston$zk_codex$ZK_Data$Character(_dpreston$zk_codex$ZK_Data$Reaper);
							case 'aberration':
								return _dpreston$zk_codex$ZK_Data$Character(_dpreston$zk_codex$ZK_Data$Aberration);
							default:
								break _v0_12;
						}
					case 'power':
						switch (_p0._1._0) {
							case 'elemental':
								return _dpreston$zk_codex$ZK_Data$Power(_dpreston$zk_codex$ZK_Data$Elemental);
							case 'hyper':
								return _dpreston$zk_codex$ZK_Data$Power(_dpreston$zk_codex$ZK_Data$Hyper);
							case 'shadow':
								return _dpreston$zk_codex$ZK_Data$Power(_dpreston$zk_codex$ZK_Data$Shadow);
							case 'unknown':
								return _dpreston$zk_codex$ZK_Data$Power(_dpreston$zk_codex$ZK_Data$Unknown);
							default:
								break _v0_12;
						}
					case 'world':
						switch (_p0._1._0) {
							case 'location':
								return _dpreston$zk_codex$ZK_Data$World(_dpreston$zk_codex$ZK_Data$Location);
							case 'faction':
								return _dpreston$zk_codex$ZK_Data$World(_dpreston$zk_codex$ZK_Data$Faction);
							case 'house':
								return _dpreston$zk_codex$ZK_Data$World(_dpreston$zk_codex$ZK_Data$House);
							case 'other':
								return _dpreston$zk_codex$ZK_Data$World(_dpreston$zk_codex$ZK_Data$Other);
							default:
								break _v0_12;
						}
					default:
		...
		return _dpreston$zk_codex$ZK_Data$Invalid;
	}();
	return _elm_lang$core$Json_Decode$succeed(category);
};
var _dpreston$zk_codex$ZK_Data$recordDecoder = A3(
	_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
	'entries',
	_elm_lang$core$Json_Decode$list(_dpreston$zk_codex$ZK_Data$entryDecoder),
	A3(
		_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
		'firstPage',
		_elm_lang$core$Json_Decode$int,
		A3(
			_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
			'category',
			A2(_elm_lang$core$Json_Decode$andThen, _dpreston$zk_codex$ZK_Data$categoryDecoder, _elm_lang$core$Json_Decode$string),
			A3(
				_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
				'name',
				_elm_lang$core$Json_Decode$string,
				A3(
					...
					'id',
					_elm_lang$core$Json_Decode$int,
					_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$decode(_dpreston$zk_codex$ZK_Data$Record))))));
var _dpreston$zk_codex$ZK_Data$dataDecoder = A3(
	_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
	'maxPage',
	_elm_lang$core$Json_Decode$int,
	A3(
		_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
		'records',
		_elm_lang$core$Json_Decode$list(_dpreston$zk_codex$ZK_Data$recordDecoder),
		_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$decode(_dpreston$zk_codex$ZK_Data$JsonRoot)));

var _dpreston$zk_codex$Main$entryItemView = function (entry) {
	return A2(
		...
		},
		{
			...
			_1: {
				...
				_0: A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html$text(entry.text),
						_1: {ctor: '[]'}
					}),
				_1: {ctor: '[]'}
			}
...
var _dpreston$zk_codex$Main$headerColor = function (hue) {
	return _eskimoblood$elm_color_extra$Color_Convert$colorToCssHsla(
		A4(
			_elm_lang$core$Color$hsla,
			_elm_lang$core$Basics$degrees(hue),
			1,
			0.8,
			1));
};
var _dpreston$zk_codex$Main$leftHeader = function (hue) {
	return A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
				...
				_0: _elm_lang$html$Html_Attributes$style(
					{
						...
						_0: {
							ctor: '_Tuple2',
							_0: 'color',
							_1: _dpreston$zk_codex$Main$headerColor(hue)
						},
						_1: {ctor: '[]'}
					}),
				_1: {ctor: '[]'}
		...
		{
			ctor: '::',
			_0: _elm_lang$html$Html$text('the Zombie Knight Codex'),
			_1: {ctor: '[]'}
		});
};
var _dpreston$zk_codex$Main$rightHeader = function (_p0) {
	var _p1 = _p0;
	return A2(
		_elm_lang$html$Html$div,
		{
				...
				_0: _elm_lang$html$Html_Attributes$style(
					{
						...
						_0: {
							ctor: '_Tuple2',
							_0: 'color',
							_1: _dpreston$zk_codex$Main$headerColor(_p1._1)
						},
						_1: {ctor: '[]'}
					}),
				_1: {ctor: '[]'}
...
var _dpreston$zk_codex$Main$rightView = function (model) {
	var record = A2(_elm_lang$core$Maybe$withDefault, _dpreston$zk_codex$ZK_Data$defaultRecord, model.currentRecord);
	var displayEntries = A2(
		...
		A2(
			_elm_lang$core$List$filter,
			function (e) {
				return _elm_lang$core$Native_Utils.cmp(e.page, model.filters.page) < 1;
			},
			record.entries));
	var maybeToBool = function (attr) {
		var _p2 = attr;
		if (_p2.ctor === 'Just') {
			return true;
		} else {
	...
	var summary = A2(
		...
		function (_) {
			...
			A2(
				_elm_lang$core$Maybe$withDefault,
				_dpreston$zk_codex$ZK_Data$defaultEntry,
				_elm_lang$core$List$head(
					_elm_lang$core$List$reverse(
						A2(
							_elm_lang$core$List$filter,
							function (e) {
								return maybeToBool(e.summary);
							},
							displayEntries))))));
	return A2(
		_elm_lang$html$Html$div,
		...
		{
			ctor: '::',
			_0: _dpreston$zk_codex$Main$rightHeader(
				{ctor: '_Tuple2', _0: record.name, _1: model.headerHue}),
			_1: {
				ctor: '::',
				_0: A2(
					_elm_lang$html$Html$div,
				...
				_1: {
					...
					_0: A2(
						...
						A2(
							_elm_lang$core$List$map,
							function (r) {
								return _dpreston$zk_codex$Main$entryItemView(r);
							},
							displayEntries)),
					_1: {ctor: '[]'}
				}
...
var _dpreston$zk_codex$Main$filterRecords = F2(
	function (filters, records) {
		var unionParentMatch = F2(
			function (a, b) {
				...
				do {
					if (_p3.ctor === '_Tuple2') {
						switch (_p3._0.ctor) {
							case 'Character':
								if (_p3._1.ctor === 'Character') {
									return true;
								} else {
									break _v2_3;
								}
							case 'Power':
								if (_p3._1.ctor === 'Power') {
									return true;
								} else {
									break _v2_3;
								}
							case 'World':
								if (_p3._1.ctor === 'World') {
									return true;
								} else {
									break _v2_3;
								}
		...
		return A2(
			...
			_dpreston$zk_codex$ZK_Data$recordOrdering,
			A3(
				...
				A2(
					_elm_lang$core$List$filter,
					function (r) {
						return _elm_lang$core$Native_Utils.cmp(r.firstPage, filters.page) < 1;
					},
					A2(
						_elm_lang$core$List$filter,
						function (r) {
							return A2(unionParentMatch, r.category, filters.category);
						},
						records))));
	});
var _dpreston$zk_codex$Main$Model = F6(
	function (a, b, c, d, e, f) {
		return {allRecords: a, displayRecords: b, currentRecord: c, filters: d, headerHue: e, error: f};
	});
var _dpreston$zk_codex$Main$init = A6(
	_dpreston$zk_codex$Main$Model,
	{ctor: '[]'},
	{ctor: '[]'},
	_elm_lang$core$Maybe$Nothing,
	{
		page: 1,
		maxPage: 0,
		category: _dpreston$zk_codex$ZK_Data$Character(_dpreston$zk_codex$ZK_Data$Human),
		text: _elm_lang$core$Maybe$Nothing
	},
	0,
	'');
var _dpreston$zk_codex$Main$Filters = F4(
	function (a, b, c, d) {
		return {page: a, maxPage: b, category: c, text: d};
	});
var _dpreston$zk_codex$Main$Tick = function (a) {
	return {ctor: 'Tick', _0: a};
};
var _dpreston$zk_codex$Main$subscriptions = function (model) {
	return A2(_elm_lang$core$Time$every, _elm_lang$core$Time$second * 6, _dpreston$zk_codex$Main$Tick);
};
var _dpreston$zk_codex$Main$ShowRecord = function (a) {
	return {ctor: 'ShowRecord', _0: a};
};
var _dpreston$zk_codex$Main$recordItemView = function (record) {
	return A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
			...
			_1: {
				...
				_0: _elm_lang$html$Html_Events$onClick(
					_dpreston$zk_codex$Main$ShowRecord(record.id)),
				_1: {ctor: '[]'}
			}
		},
		{
...
var _dpreston$zk_codex$Main$SelectCategory = function (a) {
	return {ctor: 'SelectCategory', _0: a};
};
var _dpreston$zk_codex$Main$UpdateSearch = function (a) {
	return {ctor: 'UpdateSearch', _0: a};
};
var _dpreston$zk_codex$Main$UpdatePage = function (a) {
	return {ctor: 'UpdatePage', _0: a};
};
var _dpreston$zk_codex$Main$filterView = function (filters) {
	var buttonClass = F2(
		function (a, b) {
			...
			do {
				if (_p4.ctor === '_Tuple2') {
					switch (_p4._0.ctor) {
						case 'Character':
							if (_p4._1.ctor === 'Character') {
								return _elm_lang$html$Html_Attributes$class('selected');
							} else {
								break _v3_3;
							}
						case 'Power':
							if (_p4._1.ctor === 'Power') {
								return _elm_lang$html$Html_Attributes$class('selected');
							} else {
								break _v3_3;
							}
						case 'World':
							if (_p4._1.ctor === 'World') {
								return _elm_lang$html$Html_Attributes$class('selected');
							} else {
								break _v3_3;
							}
		...
		},
		{
						...
						_elm_lang$html$Html$input,
						{
							...
							_1: {
								...
								_0: _elm_lang$html$Html_Attributes$value(
									_elm_lang$core$Basics$toString(filters.page)),
								_1: {
									ctor: '::',
									_0: _elm_lang$html$Html_Events$onInput(_dpreston$zk_codex$Main$UpdatePage),
									_1: {
										ctor: '::',
										_0: _elm_lang$html$Html_Attributes$max(
											_elm_lang$core$Basics$toString(filters.maxPage)),
										_1: {
											ctor: '::',
			...
			_1: {
				...
				_0: A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html_Attributes$class('category'),
						_1: {ctor: '[]'}
					},
					{
						ctor: '::',
						_0: A2(
							_elm_lang$html$Html$button,
							{
								...
								_1: {
									ctor: '::',
									_0: _elm_lang$html$Html_Events$onClick(
										_dpreston$zk_codex$Main$SelectCategory(
											_dpreston$zk_codex$ZK_Data$Character(_dpreston$zk_codex$ZK_Data$Human))),
									_1: {ctor: '[]'}
								}
							},
						...
						_1: {
							...
							_0: A2(
								_elm_lang$html$Html$button,
								{
									...
									_0: A2(
										buttonClass,
										_dpreston$zk_codex$ZK_Data$Power(_dpreston$zk_codex$ZK_Data$Elemental),
										filters.category),
									_1: {
										ctor: '::',
										_0: _elm_lang$html$Html_Events$onClick(
							...
							_1: {
								...
								_0: A2(
									_elm_lang$html$Html$button,
									{
										...
										_0: A2(
											buttonClass,
											_dpreston$zk_codex$ZK_Data$World(_dpreston$zk_codex$ZK_Data$Location),
											filters.category),
										_1: {
											ctor: '::',
											_0: _elm_lang$html$Html_Events$onClick(
							...
							_0: A2(
								_elm_lang$html$Html$input,
								{
									...
									_1: {
										...
										_1: {
											ctor: '::',
											_0: _elm_lang$html$Html_Events$onInput(_dpreston$zk_codex$Main$UpdateSearch),
											_1: {ctor: '[]'}
										}
									}
								},
...
var _dpreston$zk_codex$Main$leftView = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
		...
		{
			ctor: '::',
			_0: _dpreston$zk_codex$Main$leftHeader(model.headerHue),
			_1: {
				ctor: '::',
				_0: _dpreston$zk_codex$Main$filterView(model.filters),
				_1: {
					ctor: '::',
					_0: A2(
						_elm_lang$html$Html$div,
						...
						A2(
							_elm_lang$core$List$map,
							function (r) {
								return _dpreston$zk_codex$Main$recordItemView(r);
							},
...
var _dpreston$zk_codex$Main$view = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
			_0: _elm_lang$html$Html_Attributes$class('codex'),
			_1: {ctor: '[]'}
		},
		{
			ctor: '::',
			_0: _dpreston$zk_codex$Main$leftView(model),
			_1: {
				ctor: '::',
				_0: _dpreston$zk_codex$Main$rightView(model),
				_1: {ctor: '[]'}
			}
		});
};
var _dpreston$zk_codex$Main$FetchDataCompleted = function (a) {
	return {ctor: 'FetchDataCompleted', _0: a};
};
var _dpreston$zk_codex$Main$fetchDataCmd = A2(
	_elm_lang$http$Http$send,
	_dpreston$zk_codex$Main$FetchDataCompleted,
	A2(_elm_lang$http$Http$get, 'data.json', _dpreston$zk_codex$ZK_Data$dataDecoder));
var _dpreston$zk_codex$Main$update = F2(
	function (msg, _p5) {
		var _p6 = _p5;
		var _p13 = _p6;
		var _p12 = _p6.filters;
		var _p7 = msg;
		switch (_p7.ctor) {
			case 'FetchData':
				return {ctor: '_Tuple2', _0: _p13, _1: _dpreston$zk_codex$Main$fetchDataCmd};
			case 'FetchDataCompleted':
				var _p8 = _p7._0;
				if (_p8.ctor === 'Ok') {
					var _p9 = _p8._0.records;
					var filters_ = _elm_lang$core$Native_Utils.update(
						_p12,
						{maxPage: _p8._0.maxPage});
					return {
						ctor: '_Tuple2',
						_0: _elm_lang$core$Native_Utils.update(
							...
							{
								allRecords: _p9,
								displayRecords: A2(_dpreston$zk_codex$Main$filterRecords, _p12, _p9),
								filters: filters_
							}),
						_1: _elm_lang$core$Platform_Cmd$none
					};
				} else {
					if (_p8._0.ctor === 'BadPayload') {
						return {
							ctor: '_Tuple2',
							_0: _elm_lang$core$Native_Utils.update(
								_p13,
			...
			case 'UpdatePage':
				...
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						...
						{
							filters: filters_,
							displayRecords: A2(_dpreston$zk_codex$Main$filterRecords, filters_, _p13.allRecords)
						}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			case 'UpdateSearch':
				...
				var search_ = function () {
					var _p10 = _elm_lang$core$String$isEmpty(_p11);
					if (_p10 === false) {
			...
			case 'ShowRecord':
				var record = _elm_lang$core$List$head(
					A2(
						_elm_lang$core$List$filter,
						function (r) {
							return _elm_lang$core$Native_Utils.eq(r.id, _p7._0);
						},
						_p13.allRecords));
				return {
					ctor: '_Tuple2',
			...
			default:
				var next = _elm_lang$core$Basics$floor(_p13.headerHue + 90);
				var headerHue_ = _elm_lang$core$Basics$toFloat(
					A2(_elm_lang$core$Basics_ops['%'], next, 360));
				return {
					ctor: '_Tuple2',
					_0: _elm_lang$core$Native_Utils.update(
						_p13,
						{headerHue: headerHue_}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
		}
	});
var _dpreston$zk_codex$Main$main = _elm_lang$html$Html$program(
	{
		init: {ctor: '_Tuple2', _0: _dpreston$zk_codex$Main$init, _1: _dpreston$zk_codex$Main$fetchDataCmd},
		update: _dpreston$zk_codex$Main$update,
		subscriptions: _dpreston$zk_codex$Main$subscriptions,
		view: _dpreston$zk_codex$Main$view
	})();
var _dpreston$zk_codex$Main$FetchData = {ctor: 'FetchData'};

var Elm = {};
Elm['Main'] = Elm['Main'] || {};
if (typeof _dpreston$zk_codex$Main$main !== 'undefined') {
    _dpreston$zk_codex$Main$main(Elm['Main'], 'Main', {"types":{"unions":{"Dict.LeafColor":{"args":[],"tags":{"LBBlack":[],"LBlack":[]}},"ZK.Data.WorldType":{"args":[],"tags":{"Other":[],"Location":[],"House":[],"Faction":[]}},"Dict.Dict":{"args":["k","v"],"tags":{"RBNode_elm_builtin":["Dict.NColor","k","v","Dict.Dict k v","Dict.Dict k v"],"RBEmpty_elm_builtin":["Dict.LeafColor"]}},"ZK.Data.PowerType":{"args":[],"tags":{"Unknown":[],"Shadow":[],"Elemental":[],"Hyper":[]}},"Maybe.Maybe":{"args":["a"],"tags":{"Just":["a"],"Nothing":[]}},"ZK.Data.Category":{"args":[],"tags":{"World":["ZK.Data.WorldType"],"Invalid":[],"Power":["ZK.Data.PowerType"],"Character":["ZK.Data.CharacterType"]}},"Main.Msg":{"args":[],"tags":{"FetchData":[],"Tick":["Time.Time"],"UpdateSearch":["String"],"UpdatePage":["String"],"SelectCategory":["ZK.Data.Category"],"ShowRecord":["Int"],"FetchDataCompleted":["Result.Result Http.Error ZK.Data.JsonRoot"]}},"Dict.NColor":{"args":[],"tags":{"BBlack":[],"Red":[],"NBlack":[],"Black":[]}},"ZK.Data.CharacterType":{"args":[],"tags":{"Reaper":[],"Servant":[],"Human":[],"Aberration":[]}},"Http.Error":{"args":[],"tags":{"BadUrl":["String"],"NetworkError":[],"Timeout":[],"BadStatus":["Http.Response String"],"BadPayload":["String","Http.Response String"]}},"Result.Result":{"args":["error","value"],"tags":{"Ok":["value"],"Err":["error"]}}},"aliases":{"Http.Response":{"args":["body"],"type":"{ url : String , status : { code : Int, message : String } , headers : Dict.Dict String String , body : body }"},"ZK.Data.Entry":{"args":[],"type":"{ id : Int, page : Int, text : String, summary : Maybe.Maybe String }"},"ZK.Data.Record":{"args":[],"type":"{ id : Int , name : String , category : ZK.Data.Category , firstPage : Int , entries : List ZK.Data.Entry }"},"ZK.Data.JsonRoot":{"args":[],"type":"{ records : List ZK.Data.Record, maxPage : Int }"},"Time.Time":{"args":[],"type":"Float"}},"message":"Main.Msg"},"versions":{"elm":"0.18.0"}});
}
